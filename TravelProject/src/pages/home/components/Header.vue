...
<style lang="stylus" scoped>
  ...
  .header
    ...
    .header-input
      flex:1;height: .64rem;line-height: .64rem;margin-top: .12rem;margin-left: .12rem;padding:0 .2rem;background-color: #fff;
      .h-input
        padding-left: .4rem;width:100%;box-sizing: border-box;
      .iconfont
